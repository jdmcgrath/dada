...
import ActivityIdeasPenguin from "../../assets/img/CategoryPage/ActivityIdeasPenguin.svg";
        ...
        <div>
            ...
            <div className={styles.splash} >
                ...
                <h1 className={styles.slogan}>your pocket</h1>
                    ...
                    <img src={DeviceMockup}></img>


                    <div className={styles.textUndePhoneCont}>
                        <h3 className={styles.textUnderPhone}>Most parenting resources are</h3>
                        <h3 className={styles.textUnderPhone}>built with moms in mind.</h3>
                        </div>
                        <h3 className={styles.forDad}>We've created one for you , Dad!</h3>
                        <p className={styles.textFathers}>We want to empower fathers to parent with confidence and enjoy more quality time with</p>
                        <p>their kids.</p>
                ...
                <div className={styles.svgTextList}>
                    <ul>
                        <li className={styles.svgTextLi}><p>Low-effort activity ideas to suit your mood and budget</p><img src={ActivityIdeasPenguin}/></li>
                        <li className={styles.svgTextLi}><img src={ActivityIdeasPenguin}/><p>Fast and clear answers to most common parenting challenges</p></li>
                        <li className={styles.svgTextLi}><p>Cliff-notes from top-rated parenting books (because who has the time to read the whole thing?)</p><img src={ActivityIdeasPenguin}/></li>
                        <li className={styles.svgTextLi}><img src={ActivityIdeasPenguin}/><p>Longer reads for the SuperDads out there</p></li>
                    </ul>
                </div>
